...
import type { PyasicMinerInfo } from "@pluto/interfaces";

/**
 * Creates a minimal pyasic miner info fixture with sensible defaults.
 * Override specific fields as needed for tests.
 *
 * Note: this is a shared test helper, not a Jest test file. It lives under
 * __tests__/fixtures so it can be imported from multiple specs.
 */
