...
try:
    from main import normalize_miner_data, normalize_hashrate_structure, normalize_efficiency_structure, convert_hashrate_to_ghs
...
def test_hashrate_normalization():
    ...
    print(f"Output: {json.dumps(normalized, indent=2)}")
    print(f"Expected: ~974.96 GH/s (0.9749575806 TH/s)")
    print(f"Got: {normalized['rate']} GH/s")
    ...
    print(f"Output: {json.dumps(normalized, indent=2)}")
    print(f"Expected: 0.5 GH/s (500 MH/s)")
    print(f"Got: {normalized['rate']} GH/s")
    ...
    print(f"Input: None")
    print(f"Output: {json.dumps(normalized, indent=2)}")
    print(f"Expected: 0.0 GH/s with default structure")
    print(f"Got: {normalized['rate']} GH/s")
