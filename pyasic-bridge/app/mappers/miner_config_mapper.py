...
def miner_config_to_pyasic(
    ...
    # Preserve and merge extra_config using the same field-by-field strategy
    # as the legacy dict-based mapper.
    ...
    if extra_dict:
        ...
        pyasic_config.extra_config = type(existing_extra)(**merged_extra)
    else:
