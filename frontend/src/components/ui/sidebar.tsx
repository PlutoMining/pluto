...
import { IconSidebarToggle } from "@/components/icons/FigmaIcons";
...
export function SidebarTrigger({
  ...
  return (
    ...
    >
      {state === "collapsed" ? (
        <IconSidebarToggle direction="right" className="h-5 w-5 text-current" />
      ) : (
        <IconSidebarToggle direction="left" className="h-5 w-5 text-current" />
      )}
...
export function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] sm:flex",
...
export function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "pointer-events-none absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums select-none text-sidebar-foreground",
...
export function SidebarMenuSkeleton({
  ...
  // NOTE: keep deterministic in tests; callers can pass their own skeleton.
  return (
    <div
...
export function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground outline-hidden ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate",
