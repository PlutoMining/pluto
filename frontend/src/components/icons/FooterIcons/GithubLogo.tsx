...
export const GithubLogo = ({ url, target, className }: GithubLogoProps) => {
  return (
    <a href={url} target={target} rel={target === "_blank" ? "noreferrer" : undefined} className={className}>
      <svg
        width="20"
        height="16"
        viewBox="0 0 98 96"
      ...
      >
        <g clipPath="url(#clip0_2278_3732)">
          <path
