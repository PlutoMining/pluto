...
export const AddNewPresetModal: React.FC<AddNewPresetModalProps> = ({
  ...
  return (
    <Modal onClose={onClose} size={"full)"} isOpen={isOpen}>
      <ModalOverlay />
      <ModalContent bg={theme.colors.greyscale[0]} borderRadius={"1rem"} height={"calc(100% - 8rem)"}>
        <Box maxW="container.2xl" margin={"0 auto"} p={'2rem'}>
          <ModalHeader p={0} fontFamily={'heading'} fontWeight={400} fontSize={'2rem'}>Add a new preset</ModalHeader>
          <ModalCloseButton />
