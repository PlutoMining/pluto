...
update_version() {
    ...
    sed -i -E "s/plutomining\/pluto\/pluto-$service(\:[^\s]+)/plutomining\/pluto\/pluto-$service:${new_version}/g" umbrel-apps/pluto-next/docker-compose.yml
    sed -i -E "s/plutomining\/pluto\/pluto-$service(\:[^\s]+)/plutomining\/pluto\/pluto-$service:${new_version}/g" docker-compose.next.local.yml

    sed -i -E "s/plutomining\/pluto\/pluto-$service(\:[^\s]+)/plutomining\/pluto\/pluto-$service:${new_version}/g" umbrel-apps/pluto/docker-compose.yml
